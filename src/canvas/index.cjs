const Canvas = require('./lib/canvas.cjs')
const Image = require('./lib/image.cjs')
const CanvasRenderingContext2D = require('./lib/context2d.cjs')
const CanvasPattern = require('./lib/pattern.cjs')
const packageJson = require('./package.json')
const bindings = require('./lib/bindings.cjs')
const fs = require('fs')
const PNGStream = require('./lib/pngstream.cjs')
const PDFStream = require('./lib/pdfstream.cjs')
const JPEGStream = require('./lib/jpegstream.cjs')
const { DOMPoint, DOMMatrix } = require('./lib/DOMMatrix.cjs')
